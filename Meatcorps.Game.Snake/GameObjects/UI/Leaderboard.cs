...
public class Leaderboard : SnakeGameObject, IIntroSlide
{
    ...
    protected override void OnInitialize()
    {
        ...
        {
            _scoreRenderer
                .AddLabel(Fonts.GetFont(),$"{counter}_1", score.rank.ToString() + " ", 16, Color.Blue, fixedWidth: false)
                .AddLabel(Fonts.GetFont(), $"{counter}_2", score.item.Name, 12, Color.White, fixedWidth: true, fixedHeight: true,
