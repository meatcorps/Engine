...
public class PowerPellet: ResourceGameObject, ICollisionEventsFiltered
{
    ...
    private RandomEnum<GameSounds> _randomSound = new RandomEnum<GameSounds>()
        ...
        .AddGroup()
        .Add(GameSounds.NlsupercyberPlayer1, 25)
        .Add(GameSounds.NlsuperrcyberPlayer2, 25)
        .Add(GameSounds.NlsuperrrrcyberPlayer, 25)
        .AddGroup()
    ...
    protected override void OnInitialize()
    {
        ...
        Scene.AddGameObject(new Drone(_body.Position, GameSprites.SuperCyberPlayerPowerUp1, () => Enabled = true, 6000));
    }
    ...
    {
        Sprites.Draw(GameSprites.SuperCyberPlayerPowerUp1, LevelData.ToWorldPosition(_position), Color.White);
    }
