...
public class EndGameGameObject : ResourceGameObject
{
    ...
    protected override void OnDraw()
    {
        ...
        Raylib.DrawRectangleGradientH(0, 0, RenderTarget!.RenderWidth, RenderTarget!.RenderHeight,
            Raylib.ColorFromHSV(_timer.NormalizedElapsed * 360, 0.2f, 0.4f),
            Raylib.ColorFromHSV(_timer.NormalizedElapsed * 360, 0.1f, 0.1f));
        Raylib.DrawTextEx(Fonts.GetFont(), str,
            new Vector2((float)RenderTarget!.RenderWidth / 2 - size.X / 2, RenderTarget!.RenderHeight - 16 - size.Y), 10, 1,
            Color.White);
