...
public class GuidePage : ResourceGameObject, IIntroSlide
{
    ...
    protected override void OnDraw()
    {
        ...
        Sprites.DrawAnimationWithNormal(GameSprites.GhostAttackerAnimation, _pokeTimer.NormalizedElapsed,
            new Vector2(16, 90), Color.White);
        Sprites.Draw(GameSprites.GhostAngry,
            new Vector2(16, 90), Color.White);
        Sprites.DrawAnimationWithNormal(GameSprites.GhostAnotherAnimation, _pokeTimer.NormalizedElapsed,
            new Vector2(32, 90), Color.White);
        Sprites.Draw(GameSprites.GhostAngry,
            new Vector2(32, 90), Color.White);
        Sprites.DrawAnimationWithNormal(GameSprites.GhostStrangeAnimation, _pokeTimer.NormalizedElapsed,
            new Vector2(48, 90), Color.White);
        Sprites.Draw(GameSprites.GhostAngry,
            new Vector2(48, 90), Color.White);
        Sprites.DrawAnimationWithNormal(GameSprites.GhostEmoAnimation, _pokeTimer.NormalizedElapsed,
            new Vector2(64, 90), Color.White);
        Sprites.Draw(GameSprites.GhostAngry,
            new Vector2(64, 90), Color.White);
        Raylib.DrawTextEx(Fonts.GetFont(), "WATCH OUT FOR THE GHOSTS!", new Vector2(88, 94), 8, 0, Color.White);
