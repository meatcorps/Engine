...
public class ExtraCollectable: ResourceGameObject, ICollisionEventsFiltered
{
    ...
    protected override void OnInitialize()
    {
        ...
        Scene.AddGameObject(new Drone(_body.Position, GameSprites.SuperCyberPlayerPowerUp2, () => Enabled = true, _position.X * 10));
    }
    ...
    protected override void OnDraw()
    {
        ...
        if (!_isCollected)
            Sprites.Draw(GameSprites.SuperCyberPlayerPowerUp2, worldPosition, Raylib.ColorAlpha(Color.White, 1f));
    }
