...
public abstract class GhostLogic: BaseGridDistanceResource
{
    ...
    public PointInt GetTarget(GhostState state)
    {
        ...
        if (LevelData.GhostScared && LevelData.TargetCyberPlayer != null)
            return LevelData.WorldToCell(LevelData.TargetCyberPlayer.Body.Position + new Vector2(LevelData.GridSize / 2f, LevelData.GridSize / 2f));
