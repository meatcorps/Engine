...
namespace Meatcorps.Game.ArcadeTemplate.Input;

public static class InputMapper
{
    public static IInputMapper<GameInput> ArduinoInput()
    {
        var mapper = new ArduinoInputMapper<GameInput>(GlobalObjectManager.ObjectManager.Get<ArduinoControllerManager>()!);
        ...
        GlobalObjectManager.ObjectManager.Register<IInputMapperWithManager<GameInput, ArduinoControllerManager>>(mapper);
