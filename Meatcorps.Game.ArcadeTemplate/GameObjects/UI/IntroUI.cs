...
public class IntroUI: ResourceGameObject, IIntroSlide
{
        ...
        if (_messageTimer.Output && _introScene.TotalPlayersReady == 0)
        {
            ...
            switch (_counter)
            {
                case 1:
                    ...
                    break;
                case 2:
                    targetText = "Lorem ipsum dolor sit amet";
                    break;
                case 3:
                    targetText = "Atom whopsom whatever";
                    break;
            }
    ...
    protected override void OnDraw()
    {
        ...
        Raylib.DrawTextEx(Fonts.GetFont(), _introScene.TotalPlayersReady > 0 ? "READY?" : _game.Name, new Vector2(startPosX + 8, startPosY + 80), 32, 0, colorTitle);
         
        if (_introScene.TotalPlayersReady == 0 || _fastTimer.NormalizedElapsed > 0.5f)
        {
            Sprites.DrawAnimationWithNormal(GameSprites.ArcadeButtonPlayerOneAnimation, _buttonTimer.NormalizedElapsed, new Vector2(startPosX + 16, startPosY + 172), Color.LightGray);
            ...
            _introScene.TotalPlayersReady != 1)
        {
            ...
            Sprites.DrawAnimationWithNormal(GameSprites.ArcadeButtonPlayerTwoAnimation, _buttonTimer.NormalizedElapsed, new Vector2(startPosX + targetWidth - 48, startPosY + 196), Color.LightGray);
        }
