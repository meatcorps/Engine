...
{
    public static UIMessageStyle Default(Font font)
    {
        return new UIMessageStyle
        {
    ...
    public static UIMessageStyle Warning(Font font)
    {
        return new UIMessageStyle
        {
    ...
    public static UIMessageStyle Countdown(Font font)
    {
        return new UIMessageStyle
        {
