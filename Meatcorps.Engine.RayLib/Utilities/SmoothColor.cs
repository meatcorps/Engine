...
public class SmoothColor
{
    ...
    /// </summary>
    public Color DisplayValue => new((byte)_redD, (byte)_greenD, (byte)_blueD, (byte)_alphaD);
    ...
    {
        get => new((byte)_red, (byte)_green, (byte)_blue, (byte)_alpha);
        set
        {
            _red = value.R;
            _green = value.G;
    ...
    public bool IsAtRealValue
    {
        get
        {
            ...
            return realColor.R == displayColor.R && realColor.G == displayColor.G && realColor.B == displayColor.B &&
                   realColor.A == displayColor.A;
        }
    }
