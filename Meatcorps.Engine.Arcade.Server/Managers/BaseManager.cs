...
public abstract class BaseManager: IDisposable
{
    ...
    private readonly SignalValue<ArcadeCentralData, SignalDefault> _dataSignal = new SignalValue<ArcadeCentralData, SignalDefault>(SignalDefault.Internal, nameof(ArcadeCentralData));
