...
namespace Meatcorps.Game.GameStarter.Data;
...
public class GameConfig<T> : BaseConfig<GameConfig<T>> where T : Enum
{
    ...
    {
        // Setup here your default values
    }
    ...
    {
        float.TryParse(GetOrDefault(key, defaultValue?.ToString(CultureInfo.InvariantCulture)),
            CultureInfo.InvariantCulture, out var result);
        return result;
    }
